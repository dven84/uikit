...
?>
<?php if ($item['meta'] && $data['meta_align'] == 'top') : ?><div<?= Uikit::attrs($attrs_meta) ?>><?= $item['meta'] ?></div><?php endif ?>
<?php if ($item['title']) : ?>
...
<?php endif ?>
<?php if ($item['meta'] && $data['meta_align'] == 'bottom') : ?><div<?= Uikit::attrs($attrs_meta) ?>><?= $item['meta'] ?></div><?php endif ?>
<?php if ($item['content']) : ?>
